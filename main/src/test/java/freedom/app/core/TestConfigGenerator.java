...
import static freedom.app.VpnProfile.AUTH_RETRY_NOINTERACT;
import static freedom.app.VpnProfile.TYPE_USERPASS;
...
public class TestConfigGenerator {
    ...
    public void testAuthRetryGen() throws PackageManager.NameNotFoundException {
        ...
        when(mc.getPackageName()).thenReturn("freedom.app");
        when(mc.getPackageManager()).thenReturn(mpm);
        when(mpm.getPackageInfo(eq("freedom.app"),eq(0))).thenReturn(mpi);*/

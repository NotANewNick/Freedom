...
import freedom.app.fragments.Utils
import freedom.app.views.FileSelectLayout
import freedom.app.views.FileSelectLayout.FileSelectCallback
...
class ConfigConverter : BaseActivity(), FileSelectCallback, View.OnClickListener {
    ...
    companion object {
        ...
        @kotlin.jvm.JvmField
        val IMPORT_PROFILE = "freedom.app.IMPORT_PROFILE"
        val IMPORT_PROFILE_DATA = "freedom.app.IMPORT_PROFILE_DATA"

...
def parse_aschex_report_rsp(aschex_report):
    ...
    try:
        ...
        if mask & rsp_mask_current_mileage:
            dbg_print(dbg_on, 'current_mileage: %s' % rsp_frame[len_parsed+4:])
            len_parsed+=4 # reserved bytes
        ...
        if mask & rsp_mask_current_hmc:
            ...
            len_parsed-=4 # no longer reserved bytes
...
if __name__ == '__main__':
    x = parse_aschex_report_rsp(
        '2B4253500700FC07BF005C560200022A56332205064B0900220C11010100030400E1002B00FCCE79038E2E6607E802060D013402400001001B018AA80B000000000000032E0300000000000000000007E802060D013647A9E9F60D0A')
    print(x)
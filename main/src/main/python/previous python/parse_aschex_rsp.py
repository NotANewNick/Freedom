...
class Position:
    def __init__(self, accuracy, longitude, latitude, gps_utc_t,
        ...
        self.ta = ta
        #array = [self.accuracy,self.speed,self.heading,self.altitude,self.longitude,self.latitude,self.gps_utc_t,]
        # return array
...
if __name__ == '__main__':
    x = parse_aschex_report_rsp("2B5253500700FE0FBF005D2F06050A060C22384E5A0B0B010001002100100100000000000000000000000000000000000000000000000460000056782D8000000000000000000000000000000000000007E10318070723005352160D0A")
    print(x)
...
evt_msg_type_str = { 0: 'UNK0',35: 'VGN', 36: 'VGF'}
class GeoFence:
...
if __name__ == '__main__':
    x = parse_aschex_report_evt('2B4556542300FC17BF0063560200022A56332205064B090036352200000400000000010000000000000000000000000000000000000000000000024000010089018DE51500000000000001CC0700000000000000000007E8011E0E05024202C8EE0D0A')
    print(x)
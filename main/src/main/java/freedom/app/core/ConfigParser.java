...
public class ConfigParser {
    ...
    public VpnProfile convertProfile() throws ConfigParseError, IOException {
        ...
        np.mAllowedAppsVpn.add("freedom.app");
        // Removed: "com.android.application" was an invalid/non-existent package name with no effect.
        // Removed: "com.simplesockettester" was a dev tool used to test the TCP server; not needed in production.
        //np.mAllowedAppsVpn.add("freedom.app");
        //np.mAllowedAppsVpn.add("com.android.application");
        //np.mAllowedAppsVpn.add("com.simplesockettester");
        np.mAllowedAppsVpnAreDisallowed = false;
        fixup(np);

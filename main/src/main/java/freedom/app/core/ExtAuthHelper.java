...
import freedom.app.api.ExternalCertificateProvider;
...
public class ExtAuthHelper {
    ...
    public static final String ACTION_CERT_CONFIGURATION = "freedom.app.api.ExternalCertificateConfiguration";
    public static final String ACTION_CERT_PROVIDER = "freedom.app.api.ExternalCertificateProvider";

    public static final String EXTRA_ALIAS = "freedom.app.api.KEY_ALIAS";
    public static final String EXTRA_DESCRIPTION = "freedom.app.api.KEY_DESCRIPTION";

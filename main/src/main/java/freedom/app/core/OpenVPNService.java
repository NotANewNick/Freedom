...
import static freedom.app.VpnProfile.EXTRA_PROFILEUUID;
import static freedom.app.VpnProfile.EXTRA_PROFILE_VERSION;
import static freedom.app.core.ConnectionStatus.LEVEL_CONNECTED;
import static freedom.app.core.ConnectionStatus.LEVEL_WAITING_FOR_USER_INPUT;
import static freedom.app.core.NetworkSpace.IpAddress;
...
import freedom.app.LaunchVPN;
import freedom.app.R;
import freedom.app.VpnProfile;
import freedom.app.activities.DisconnectVPN;
import freedom.app.api.ExternalAppDatabase;
import freedom.app.core.VpnStatus.ByteCountListener;
import freedom.app.core.VpnStatus.StateListener;
import freedom.app.tcpserver.IMessageReceived;
import freedom.app.tcpserver.TcpClientHandler;

public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal, IMessageReceived {
    public static final String START_SERVICE = "freedom.app.START_SERVICE";
    public static final String START_SERVICE_STICKY = "freedom.app.START_SERVICE_STICKY";
    public static final String ALWAYS_SHOW_NOTIFICATION = "freedom.app.NOTIFICATION_ALWAYS_VISIBLE";

    public static final String EXTRA_DO_NOT_REPLACE_RUNNING_VPN = "freedom.app.DO_NOT_REPLACE_RUNNING_VPN";

    public static final String EXTRA_START_REASON = "freedom.app.startReason";

    public static final String DISCONNECT_VPN = "freedom.app.DISCONNECT_VPN";
    ...
    public static final String EXTRA_CHALLENGE_TXT = "freedom.app.core.CR_TEXT_CHALLENGE";
    public static final String EXTRA_CHALLENGE_OPENURL = "freedom.app.core.OPENURL_CHALLENGE";
    private static final String PAUSE_VPN = "freedom.app.PAUSE_VPN";
    private static final String RESUME_VPN = "freedom.app.RESUME_VPN";
    ...
    private void showNotification(final String msg, String tickerText, @NonNull String channel,
        ...
        if (mProfile != null)
            ...
            nbuilder.setContentTitle(getString(R.string.notification_title_new));
        else
    ...
    synchronized void unregisterDeviceStateReceiver(DeviceStateReceiver deviceStateReceiver) {
        if (mDeviceStateReceiver != null)
            try {
                ...
                // java.lang.IllegalArgumentException: Receiver not registered: freedom.app.NetworkSateReceiver@41a61a10
                // Ignore for now ...
                iae.printStackTrace();
            }
    }
    ...
    private boolean checkVPNPermission(VpnProfile startprofile) {
        ...
        launchVPNIntent.putExtra(freedom.app.LaunchVPN.EXTRA_HIDELOG, true);
    ...
    private OpenVPNManagement instantiateOpenVPN3Core() {
        try {
            Class<?> cl = Class.forName("freedom.app.core.OpenVPNThreadv3");
    ...
    public void onCreate() {
        ...
        PORT = prefs.getInt("vpn_port", 38009); // Now context is safe to use

        clientId = prefs.getString("vpn_file_name","");

    }

    private ServerSocket mServerSocket = null;
    private IMessageReceived mInterface = null;
    //gb130mg testing
    int PORT = 38009;
//    gv500MA Mikael's device
//    int PORT = 22175;
    ...
    private final Runnable runnable = () -> {
        Socket socket = null;
        try {
            System.out.println("Port from pref: "+PORT);
            TrafficStats.setThreadStatsTag((int) Thread.currentThread().getId());
            TrafficStats.setThreadStatsTag(42);
            mServerSocket = new ServerSocket(PORT);
            mInterface = OpenVPNService.this;
            while (!Thread.currentThread().isInterrupted()) {
                ...
                if (mServerSocket != null) {
                    ...
                    try {
                        ...
                        Thread t = new TcpClientHandler(
                                getApplication(),
                                socket, OpenVPNService.this, null);
                        t.start();
                    } catch (IOException e){
                        System.out.println("Exception in accept(): " + e.getMessage());
                        Log.e(TAG, "Exception in accept(): " + e.getMessage());
                        e.printStackTrace();
                    }
    ...
    public String MESSAGE_RECEIVER = "MESSAGE_RECEIVER";
    public String MESSAGE_KEY = "MESSAGE_KEY";
    public String MESSAGE_COUNT = "MESSAGE_COUNT";

    @Override
    public void messageReceived(@NonNull byte[] message, @Nullable Integer count) {
    ...
    @Override
    public void messageReceivedInString(@NonNull String message) {
    ...
    private void doSendBroadcast(String state, ConnectionStatus level) {
        ...
        vpnstatus.setAction("freedom.app.VPN_STATUS");

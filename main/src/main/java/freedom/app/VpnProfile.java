...
import static freedom.app.core.OpenVPNService.EXTRA_DO_NOT_REPLACE_RUNNING_VPN;
...
public class VpnProfile implements Serializable, Cloneable {
    ...
    public static final String EXTRA_PROFILEUUID = "freedom.app.profileUUID";
    public static final String EXTRA_PROFILE_VERSION = "freedom.app.profileVersion";
    ...
    private static final String EXTRA_RSA_PADDING_TYPE = "freedom.app.api.RSA_PADDING_TYPE";
    private static final String EXTRA_SALTLEN = "freedom.app.api.SALTLEN";
    private static final String EXTRA_NEEDS_DIGEST = "freedom.app.api.NEEDS_DIGEST";
    private static final String EXTRA_DIGEST = "freedom.app.api.DIGEST";

...
import freedom.app.core.OpenVPNService;
...
public class ExternalOpenVPNService extends Service implements StateListener {
    ...
    private static final String EXTRA_INLINE_PROFILE_ALLOW_VPN_BYPASS = "freedom.app.api.ALLOW_VPN_BYPASS";
    ...
    private final IOpenVPNAPIService.Stub mBinder = new IOpenVPNAPIService.Stub() {
        ...
        private void startProfile(VpnProfile vp)
        {
            ...
            if(vpnPermissionIntent != null || neddPassword != 0){
                ...
                shortVPNIntent.setClass(getBaseContext(), freedom.app.LaunchVPN.class);
                shortVPNIntent.putExtra(freedom.app.LaunchVPN.EXTRA_KEY, vp.getUUIDString());
                shortVPNIntent.putExtra(freedom.app.LaunchVPN.EXTRA_HIDELOG, true);
                shortVPNIntent.putExtra(freedom.app.core.OpenVPNService.EXTRA_START_REASON, startReason);

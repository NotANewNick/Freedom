...
public class ConfirmDialog extends Activity implements
        CompoundButton.OnCheckedChangeListener, DialogInterface.OnClickListener, View.OnClickListener {
    private static final String TAG = "OpenVPNVpnConfirm";

    public static final String EXTRA_PACKAGE_NAME = "android.intent.extra.PACKAGE_NAME";

    public static final String ANONYMOUS_PACKAGE = "freedom.app.ANYPACKAGE";
...
//            builder.setNegativeButton(android.R.string.cancel, this);
            ...
            Builder builder = new AlertDialog.Builder(this);
            builder.setPositiveButton(R.string.allow,this);
            builder.setNegativeButton(R.string.dallow,this);
...
//            setResult(RESULT_CANCELED);
//            finish();
            showRequiredFunctionDialog(this);
        }
    }
    ...
    public void showRequiredFunctionDialog(Context context) {
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        builder.setTitle(R.string.required_function);
        builder.setMessage(R.string.required_function_title);

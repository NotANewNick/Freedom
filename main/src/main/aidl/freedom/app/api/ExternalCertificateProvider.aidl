...
interface ExternalCertificateProvider {
     ...
     *
     * EXTRA_ALIAS = "freedom.app.api.KEY_ALIAS"
     * EXTRA_DESCRIPTION = "freedom.app.api.KEY_DESCRIPTION"
     *
     ...
     * <ul>
       * <li>int key "freedom.app.api.RSA_PADDING_TYPE", may be set as:
       * <ul>
         * <li>0 - for RSA/ECB/nopadding
         * <li>1 - for RSA/ECB/PKCS1PADDING
         * <li>2 - for PKCS1PSSPADDING
       * </ul>
       * <li>string key "freedom.app.api.SALTLEN", may be set as:
       * <ul>
       ...
       * </ul>
       * <li>boolean key "freedom.app.api.NEEDS_DIGEST", indicating that the data should be
         * hashed before signing or not
       * <li>string key "freedom.app.api.DIGEST", the short common digest algorithm name to
